...
public class CustomListAdapterViewMyNotices extends ArrayAdapter<String> {
    ...
    public CustomListAdapterViewMyNotices(Activity context, ArrayList<String> itemname, ArrayList<String> itemname1) {
